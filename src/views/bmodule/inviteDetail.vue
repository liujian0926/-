<template>
  <div class="container">
    ...
    >
      ...
      <el-table-column prop="add_time" label="注册时间" width="180px" align="center"></el-table-column>
      <el-table-column prop="pid" label="推荐人ID" align="center"></el-table-column>
      <!-- <el-table-column prop="invite_num" label="团队人数" align="center"></el-table-column> -->
    </el-table>
